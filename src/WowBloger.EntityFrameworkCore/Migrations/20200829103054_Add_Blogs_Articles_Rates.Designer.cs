...
namespace WowBloger.Migrations
{
    ...
    [Migration("20200829103054_Add_Blogs_Articles_Rates")]
    partial class Add_Blogs_Articles_Rates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WowBloger.Blogs.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WowBloger.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WowBloger.Blogs.Rate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WowBloger.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WowBloger.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WowBloger.Blogs.Article", b =>
                {
                    b.HasOne("WowBloger.Blogs.Blog", "Blog")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("WowBloger.Blogs.Rate", b =>
                {
                    b.HasOne("WowBloger.Blogs.Article", "Article")
                        .WithMany("Rates")
