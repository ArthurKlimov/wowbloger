...
using WowBloger.Models.TokenAuth;
...
{
    public abstract class WowBlogerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WowBlogerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WowBlogerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WowBlogerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WowBlogerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WowBlogerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WowBlogerDbContext, Task<T>> func)
        {
            T result;
